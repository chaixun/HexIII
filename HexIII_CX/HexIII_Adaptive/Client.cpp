...
int OnControlCommandNeeded(Aris::Core::MSG &msg)
{
    ...
    cout<<"1.Eanble"<<endl<<"2.Disable"<<endl<<"3.Home"<<endl<<"4.Home to standstill"<<endl<<"5.Forward"<<endl<<"6.Back"
       <<endl<<"7.Walk Adaptive"<<endl<<"8.Turn left"<<endl<<"9.Turn right"<<endl<<"10.Begin Discover"<<endl<<"11.End Discover"<<endl;
    cout<<"Please enter your command: ";
    cin>>cmd;
    while(cmd!=1&&cmd!=2&&cmd!=3&&cmd!=4&&cmd!=5&&cmd!=6&&cmd!=7&&cmd!=8&&cmd!=9&&cmd!=10&&cmd!=11)
    {
