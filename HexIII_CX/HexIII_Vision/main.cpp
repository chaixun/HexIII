...
int main()
{
    ...
    Aris::Core::RegisterMsgCallback(RC_WALK_ADAPTOVE, autoAdaptive);
    Aris::Core::RegisterMsgCallback(RC_TURN_LEFT,autoTurnLeft);
    Aris::Core::RegisterMsgCallback(RC_TURN_RIGHT,autoTurnRight);
    Aris::Core::RegisterMsgCallback(RC_BEGIN_DISCOVER,autoBeginDiscover);
    Aris::Core::RegisterMsgCallback(RC_END_DISCOVER,autoEndDiscover);
    Aris::Core::RegisterMsgCallback(RC_AUTO_AVOID, autoAvoid);
