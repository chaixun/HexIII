...
LEG::LEG(const char *Name, ROBOT* probot, LEGP *pLegP, double * ep)
    ...
    , S3y(0), S3z(0), Sfx(0), Sfy(0), Sfz(0), D1(0), H1(0), D2(0), H2(0)
{
    ...
    double im[6][6];
    double pm[4][4];
    s_ep2pm(pLegP->P1aCM, *pm);
    s_mass2im(pLegP->P1aMass, *pLegP->P1aInertia, *pm, *im);
    strcpy(temName, _Name.data());
    strcat(temName, "_P1a");
    pP1a = probot->AddPart(temName, *im);

    s_ep2pm(pLegP->P2aCM, *pm);
    s_mass2im(pLegP->P2aMass, *pLegP->P2aInertia, *pm, *im);
    strcpy(temName, _Name.data());
    strcat(temName, "_P2a");
    pP2a = probot->AddPart(temName, *im);

    s_ep2pm(pLegP->P3aCM, *pm);
    s_mass2im(pLegP->P3aMass, *pLegP->P3aInertia, *pm, *im);
    strcpy(temName, _Name.data());
    strcat(temName, "_P3a");
    pP3a = probot->AddPart(temName, *im);

    s_ep2pm(pLegP->ThighCM, *pm);
    s_mass2im(pLegP->ThighMass, *pLegP->ThighInertia, *pm, *im);
    strcpy(temName, _Name.data());
    strcat(temName, "_Thigh");
    pThigh = probot->AddPart(temName, *im);

    s_ep2pm(pLegP->P2bCM, *pm);
    s_mass2im(pLegP->P2bMass, *pLegP->P2bInertia, *pm, *im);
    strcpy(temName, _Name.data());
    strcat(temName, "_P2b");
    pP2b = probot->AddPart(temName, *im);

    s_ep2pm(pLegP->P3bCM, *pm);
    s_mass2im(pLegP->P3bMass, *pLegP->P3bInertia, *pm, *im);
    strcpy(temName, _Name.data());
    strcat(temName, "_P3b");
    pP3b = probot->AddPart(temName, *im);

    s_ep2pm(ep, *pm);
    strcpy(temName, _Name.data());
    strcat(temName, "_Base");
    pBase = probot->pBody->AddMarker(temName, *pm);

    s_ep2pm(pLegP->U1iep, *pm);
    strcpy(temName, _Name.data());
    strcat(temName, "_U1i");
    pU1i = probot->pBody->AddMarker(temName, *pm, this->pBase);

    s_ep2pm(pLegP->U2iep, *pm);
    strcpy(temName, _Name.data());
    strcat(temName, "_U2i");
    pU2i = probot->pBody->AddMarker(temName, *pm, this->pBase);

    s_ep2pm(pLegP->U3iep, *pm);
    strcpy(temName, _Name.data());
    strcat(temName, "_U3i");
    pU3i = probot->pBody->AddMarker(temName, *pm, this->pBase);

    s_ep2pm(pLegP->U1jep, *pm);
    strcpy(temName, "U1j");
    pU1j = pP1a->AddMarker(temName, *pm);
    s_ep2pm(pLegP->U2jep, *pm);
    strcpy(temName, "U2j");
    pU2j = pP2a->AddMarker(temName, *pm);
    s_ep2pm(pLegP->U3jep, *pm);
    strcpy(temName, "U3j");
    pU3j = pP3a->AddMarker(temName, *pm);

    s_ep2pm(pLegP->P1iep, *pm);
    strcpy(temName, "P1i");
    pP1i = pThigh->AddMarker(temName, *pm);
    s_ep2pm(pLegP->P1jep, *pm);
    strcpy(temName, "P1j");
    pP1j = pP1a->AddMarker(temName, *pm);
    s_ep2pm(pLegP->P2iep, *pm);
    strcpy(temName, "P2i");
    pP2i = pP2b->AddMarker(temName, *pm);
    s_ep2pm(pLegP->P2jep, *pm);
    strcpy(temName, "P2j");
    pP2j = pP2a->AddMarker(temName, *pm);
    s_ep2pm(pLegP->P3iep, *pm);
    strcpy(temName, "P3i");
    pP3i = pP3b->AddMarker(temName, *pm);
    s_ep2pm(pLegP->P3jep, *pm);
    strcpy(temName, "P3j");
    pP3j = pP3a->AddMarker(temName, *pm);

    s_ep2pm(pLegP->Sfiep, *pm);
    strcpy(temName, "Sfi");
    pSfi = pThigh->AddMarker(temName, *pm);
    s_ep2pm(pLegP->Sfjep, *pm);
    strcpy(temName, _Name.data());
    strcat(temName, "_Sfj");
    pSfj = probot->pGround->AddMarker(temName, *pm);
    s_ep2pm(pLegP->S2iep, *pm);
    strcpy(temName, "S2i");
    pS2i = pThigh->AddMarker(temName, *pm);
    s_ep2pm(pLegP->S2jep, *pm);
    strcpy(temName, "S2j");
    pS2j = pP2b->AddMarker(temName, *pm);
    s_ep2pm(pLegP->S3iep, *pm);
    strcpy(temName, "S3i");
    pS3i = pThigh->AddMarker(temName, *pm);
    s_ep2pm(pLegP->S3jep, *pm);
    strcpy(temName, "S3j");
    pS3j = pP3b->AddMarker(temName, *pm);

    strcpy(temName, _Name.data());
    strcat(temName, "_U1");
    pU1 = probot->AddJoint(temName, Aris::DynKer::JOINT::UNIVERSAL, pU1i, pU1j);
    strcpy(temName, _Name.data());
    strcat(temName, "_U2");
    pU2 = probot->AddJoint(temName, Aris::DynKer::JOINT::UNIVERSAL, pU2i, pU2j);
    strcpy(temName, _Name.data());
    strcat(temName, "_U3");
    pU3 = probot->AddJoint(temName, Aris::DynKer::JOINT::UNIVERSAL, pU3i, pU3j);
    strcpy(temName, _Name.data());
    strcat(temName, "_P1");
    pP1 = probot->AddJoint(temName, Aris::DynKer::JOINT::PRISMATIC, pP1i, pP1j);
    strcpy(temName, _Name.data());
    strcat(temName, "_P2");
    pP2 = probot->AddJoint(temName, Aris::DynKer::JOINT::PRISMATIC, pP2i, pP2j);
    strcpy(temName, _Name.data());
    strcat(temName, "_P3");
    pP3 = probot->AddJoint(temName, Aris::DynKer::JOINT::PRISMATIC, pP3i, pP3j);
    strcpy(temName, _Name.data());
    strcat(temName, "_Sf");
    pSf = probot->AddJoint(temName, Aris::DynKer::JOINT::SPHERICAL, pSfi, pSfj);
    strcpy(temName, _Name.data());
    strcat(temName, "_S2");
    pS2 = probot->AddJoint(temName, Aris::DynKer::JOINT::SPHERICAL, pS2i, pS2j);
    strcpy(temName, _Name.data());
    strcat(temName, "_S3");
    pS3 = probot->AddJoint(temName, Aris::DynKer::JOINT::SPHERICAL, pS3i, pS3j);

    strcpy(temName, _Name.data());
    strcat(temName, "_M1");
    pM1 = probot->AddMotion(temName, MOTION::LINEAR, MOTION::POS_CONTROL, pP1->GetMakI(), pP1->GetMakJ());
    strcpy(temName, _Name.data());
    strcat(temName, "_M2");
    pM2 = probot->AddMotion(temName, MOTION::LINEAR, MOTION::POS_CONTROL, pP2->GetMakI(), pP2->GetMakJ());
    strcpy(temName, _Name.data());
    strcat(temName, "_M3");
    pM3 = probot->AddMotion(temName, MOTION::LINEAR, MOTION::POS_CONTROL, pP3->GetMakI(), pP3->GetMakJ());

    s_inv_pm_dot_pm(pBase->GetLocPmPtr(), pU2i->GetLocPmPtr(), *pm);
    *const_cast<double *>(&this->U2x) = pm[0][3];
    *const_cast<double *>(&this->U2y) = pm[1][3];
    *const_cast<double *>(&this->U2z) = pm[2][3];
    s_inv_pm_dot_pm(pBase->GetLocPmPtr(), pU3i->GetLocPmPtr(), *pm);
    *const_cast<double *>(&this->U3x) = pm[0][3];
    *const_cast<double *>(&this->U3y) = pm[1][3];
    *const_cast<double *>(&this->U3z) = pm[2][3];
    *const_cast<double *>(&this->S2x) = this->pS2i->GetLocPmPtr()[3];
    *const_cast<double *>(&this->S2y) = this->pS2i->GetLocPmPtr()[7];
    *const_cast<double *>(&this->S2z) = this->pS2i->GetLocPmPtr()[11];
    *const_cast<double *>(&this->S3x) = this->pS3i->GetLocPmPtr()[3];
    *const_cast<double *>(&this->S3y) = this->pS3i->GetLocPmPtr()[7];
    *const_cast<double *>(&this->S3z) = this->pS3i->GetLocPmPtr()[11];
    *const_cast<double *>(&this->Sfx) = this->pSfi->GetLocPmPtr()[3];
    *const_cast<double *>(&this->Sfy) = this->pSfi->GetLocPmPtr()[7];
    *const_cast<double *>(&this->Sfz) = this->pSfi->GetLocPmPtr()[11];

    *const_cast<double *>(&this->D1) = this->U2z;
    *const_cast<double *>(&this->H1) = this->U2y;
    *const_cast<double *>(&this->D2) = this->pS2i->GetLocPmPtr()[11];
    *const_cast<double *>(&this->H2) = this->pS2i->GetLocPmPtr()[7];
}
LEG::~LEG()
{
}
...
void LEG::GetPee(double *pEE, const char *RelativeCoodinate) const
{
    ...
    case 'B':
    case 'M':
        s_pm_dot_pnt(pBase->GetLocPmPtr(), this->pEE, pEE);
        break;
    case 'G':
    case 'O':
    default:
...
void LEG::GetVee(double *vEE, const char *RelativeCoodinate) const
{
    ...
    case 'B':
    case 'M':
        s_dgemm(3, 1, 3, 1, pBase->GetLocPmPtr(), 4, this->vEE, 1, 0, vEE, 1);
        break;
    case 'G':
    case 'O':
    default:
...
void LEG::GetAee(double *aEE, const char *RelativeCoodinate) const
{
    ...
    case 'B':
    case 'M':
        s_pa2pa(pBase->GetLocPmPtr(), 0, 0, this->pEE, this->vEE, this->aEE, aEE);
        break;
    case 'G':
    case 'O':
    default:
...
void LEG::GetVelJacDir(double *jac, double *c, const char *RelativeCoodinate) const
{
    ...
    case 'B':
        if (jac != nullptr)
        {
            s_dgemm(3, 3, 3, 1, pBase->GetLocPmPtr(), 4, *legJac, 3, 0, jac, 3);
        }
        if (c != nullptr)
        {
            memset(c, 0, sizeof(double)* 3);
...
void LEG::GetVelJacInv(double *jac, double *c, const char *RelativeCoodinate) const
{
    ...
    case 'B':
        if (jac != nullptr)
        {
            s_dgemmNT(3, 3, 3, 1, *legJac, 3, pBase->GetLocPmPtr(), 4, 0, jac, 3);
        }
        if (c != nullptr)
        {
            memset(c, 0, sizeof(double)* 3);
...
void LEG::GetAccJacDir(double *jac, double *c, const char *RelativeCoodinate) const
{
    ...
    case 'B':
        ...
        if (c != nullptr)
        {
            s_dgemm(3, 1, 3, 1, pBase->GetLocPmPtr(), 4, tem2, 1, 0, c, 1);
        }
        break;
    case 'G':
    case 'O':
...
void LEG::SetPee(const double *pEE, const char *RelativeCoodinate)
{
    ...
    case 'B':
    case 'M':
        s_inv_pm_dot_pnt(pBase->GetLocPmPtr(), pEE, this->pEE);
        break;
    case 'G':
    case 'O':
    default:
...
void LEG::SetVee(const double *vEE, const char *RelativeCoodinate)
{
    ...
    case 'B':
    case 'M':
        s_dgemmTN(3, 1, 3, 1, pBase->GetLocPmPtr(), 4, vEE, 1, 0, this->vEE, 1);
        break;
    case 'G':
    case 'O':
    default:
...
void LEG::SetAee(const double *aEE, const char *RelativeCoodinate)
{
    ...
    case 'B':
    case 'M':
        s_dgemmTN(3, 1, 3, 1, pBase->GetLocPmPtr(), 4, aEE, 1, 0, this->aEE, 1);
        break;
    case 'G':
    case 'O':
    default:
...
{
#define MAX_CALIBRATION_NUM 70

    static double cm[6][6];
    static double _inv_of_C[36][36], A[3][6], B[3][6], q[6],v[6];
    static int ipiv[36];

    static double _Calibration_m[MAX_CALIBRATION_NUM * 3][60], _Calibration_fce[MAX_CALIBRATION_NUM * 3];

    memset(_Calibration_m, 0, sizeof(double)*MAX_CALIBRATION_NUM*3 * 60);
    memcpy(_Calibration_fce, fplen, sizeof(double)*n * 3);
    ...
    for (int i = 0; i < n; ++i)
    {
        ...
        for (int j = 0; j < 6; j++)
        {
            ...
            static double test1[10], test2[3];
    ...
    static double s[MAX_CALIBRATION_NUM * 3];
    static double rcond;
    static int rank[MAX_CALIBRATION_NUM * 3];

    static double _tem_Calibration_m[MAX_CALIBRATION_NUM * 3][60];
    memcpy(*_tem_Calibration_m, *_Calibration_m, sizeof(double)*MAX_CALIBRATION_NUM * 3 * 60);

    s_dgelsd(n * 3, 60, 1, *_tem_Calibration_m, 60, _Calibration_fce, 1, s, rcond, rank);


    cout << "p1a:" << endl;
    dsp(_Calibration_fce, 10, 1);
    cout << "p2a:" << endl;
    dsp(_Calibration_fce+10, 10, 1);
    cout << "p3a:" << endl;
    dsp(_Calibration_fce + 20, 10, 1);
    cout << "Thigh:" << endl;
    dsp(_Calibration_fce + 30, 10, 1);
    cout << "p2b:" << endl;
    dsp(_Calibration_fce + 40, 10, 1);
    cout << "p3b:" << endl;
    dsp(_Calibration_fce + 50, 10, 1);
...
ROBOT::ROBOT()
    : Prmt(PRMT())
    , pBody(this->AddPart("MainBody"))
    , pBodyCenter(pBody->AddMarker("BodyCenter"))
    , LF_Leg("LF", this, &Prmt.LegP, Prmt.MbdP.LFep)
    , LM_Leg("LM", this, &Prmt.LegP, Prmt.MbdP.LMep)
    , LR_Leg("LR", this, &Prmt.LegP, Prmt.MbdP.LRep)
    , RF_Leg("RF", this, &Prmt.LegP, Prmt.MbdP.RFep)
    , RM_Leg("RM", this, &Prmt.LegP, Prmt.MbdP.RMep)
    , RR_Leg("RR", this, &Prmt.LegP, Prmt.MbdP.RRep)
{
    //建立模型
    ...
    s_ep2pm(Prmt.MbdP.MbdCM, *pm);
    s_mass2im(Prmt.MbdP.MbdMass, *Prmt.MbdP.MbdInertia, *pm, *im);
...
int ROBOT::LoadXML(const char *filename)
{
    ...
    for (int j = 0; j < 6; ++j)
    {
        ...
        strcat(temName, "_P1a");
        pLegs[j]->pP1a = FindPart(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P2a");
        pLegs[j]->pP2a = FindPart(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P3a");
        pLegs[j]->pP3a = FindPart(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_Thigh");
        pLegs[j]->pThigh = FindPart(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P2b");
        pLegs[j]->pP2b = FindPart(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P3b");
        pLegs[j]->pP3b = FindPart(temName);
    }
    ...
    for (int j = 0; j < 6; ++j)
    {
        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_Base");
        pLegs[j]->pBase = pBody->FindMarker(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_U1i");
        pLegs[j]->pU1i = pBody->FindMarker(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_U2i");
        pLegs[j]->pU2i = pBody->FindMarker(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_U3i");
        pLegs[j]->pU3i = pBody->FindMarker(temName);
        ...
        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_Sfj");
        pLegs[j]->pSfj = pGround->FindMarker(temName);
    }
    ...
    for (int j = 0; j < 6; ++j)
    {
        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_U1");
        pLegs[j]->pU1 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_U2");
        pLegs[j]->pU2 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_U3");
        pLegs[j]->pU3 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P1");
        pLegs[j]->pP1 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P2");
        pLegs[j]->pP2 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_P3");
        pLegs[j]->pP3 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_Sf");
        pLegs[j]->pSf = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_S2");
        pLegs[j]->pS2 = FindJoint(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_S3");
        pLegs[j]->pS3 = FindJoint(temName);
    }
    ...
    for (int j = 0; j < 6; ++j)
    {
        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_M1");
        pLegs[j]->pM1 = FindMotion(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_M2");
        pLegs[j]->pM2 = FindMotion(temName);

        strcpy(temName, pLegs[j]->_Name.data());
        strcat(temName, "_M3");
        pLegs[j]->pM3 = FindMotion(temName);
    }
    ...
    {
        double pm[4][4];
        s_inv_pm_dot_pm(pLegs[i]->pBase->GetLocPmPtr(), pLegs[i]->pU2i->GetLocPmPtr(), *pm);
        *const_cast<double *>(&pLegs[i]->U2x) = pm[0][3];
        *const_cast<double *>(&pLegs[i]->U2y) = pm[1][3];
        *const_cast<double *>(&pLegs[i]->U2z) = pm[2][3];
        s_inv_pm_dot_pm(pLegs[i]->pBase->GetLocPmPtr(), pLegs[i]->pU3i->GetLocPmPtr(), *pm);
        *const_cast<double *>(&pLegs[i]->U3x) = pm[0][3];
        *const_cast<double *>(&pLegs[i]->U3y) = pm[1][3];
        *const_cast<double *>(&pLegs[i]->U3z) = pm[2][3];
        *const_cast<double *>(&pLegs[i]->S2x) = pLegs[i]->pS2i->GetLocPmPtr()[3];
        *const_cast<double *>(&pLegs[i]->S2y) = pLegs[i]->pS2i->GetLocPmPtr()[7];
        *const_cast<double *>(&pLegs[i]->S2z) = pLegs[i]->pS2i->GetLocPmPtr()[11];
        *const_cast<double *>(&pLegs[i]->S3x) = pLegs[i]->pS3i->GetLocPmPtr()[3];
        *const_cast<double *>(&pLegs[i]->S3y) = pLegs[i]->pS3i->GetLocPmPtr()[7];
        *const_cast<double *>(&pLegs[i]->S3z) = pLegs[i]->pS3i->GetLocPmPtr()[11];
        *const_cast<double *>(&pLegs[i]->Sfx) = pLegs[i]->pSfi->GetLocPmPtr()[3];
        *const_cast<double *>(&pLegs[i]->Sfy) = pLegs[i]->pSfi->GetLocPmPtr()[7];
        *const_cast<double *>(&pLegs[i]->Sfz) = pLegs[i]->pSfi->GetLocPmPtr()[11];

        *const_cast<double *>(&pLegs[i]->D1) = pLegs[i]->U2z;
        *const_cast<double *>(&pLegs[i]->H1) = pLegs[i]->U2y;
        *const_cast<double *>(&pLegs[i]->D2) = pLegs[i]->pS2i->GetLocPmPtr()[11];
        *const_cast<double *>(&pLegs[i]->H2) = pLegs[i]->pS2i->GetLocPmPtr()[7];
    }
...
void ROBOT::SetFixedFeet(const char *fixedLeg, const char *ActiveMotion)
{
    ...
    if (fixedLeg == 0)
    {
        ...
        if (ActiveMotion == 0)
        {
            for (auto &i:_motions)
            {
                i.second.SetMode(MOTION::POS_CONTROL);
            }
        }
        else
        {
            for (auto &i : _motions)
            {
                i.second.SetMode(MOTION::FCE_CONTROL);
            }
